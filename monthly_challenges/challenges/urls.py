...
urlpatterns=[
    ...
    path("<str:month>",views.monthly_challenges_by_name,name="month-challenge"), # this <str:month> will tell django to expect a string and also convert it to a string
]